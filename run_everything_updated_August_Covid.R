...
for (i in 1:nSim) {
  ...
  treat <- sample(c(1, 0), N, replace = TRUE, prob = c(0.55, 0.45))
  ...
  df_combined <- df_combined %>%
    mutate(overall_treat_effect = treat_effect )
  ...
  treat=sample(c(1,0), N,replace=TRUE, prob=c(.86,.14))
  ...
  outcome=sample(c(1,0), N*2,replace=TRUE, prob=c(.001,.999))
  
  # other variables
  treat=sample(c(1,0), N*2,replace=TRUE, prob=c(.11,.89))
  sex <- rbinom(N, 1, 0.554)
...
save_dir <- "C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Saved_Rdata/August/CO_CART/"
...
fig_dir <- "C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Figures_Aug/CO_CART"
...
ggsave("C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Figures_Aug/CO_CART/control_response_rate_means.jpg",
       p, width = 6, height = 12)
...
list_size <- c(nSim/4, nSim/4, nSim/4, nSim/4)
save_dir <- "C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Saved_Rdata/August/CO_LL/"
...
scenarios <- 1:4
suffixes <- c("_all", "_sim", "_syn")
fig_dir <- "C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Figures_Aug/CO_LL"
...
ggsave("C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Figures_Aug/CO_LL/control_response_rate_means.jpg",
       p, width = 6, height = 12)
...
list_size <- c(nSim/4, nSim/4, nSim/4, nSim/4)
save_dir <- "C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Saved_Rdata/August/CO_RS/"
...
scenarios <- 1:4
suffixes <- c("_all", "_sim", "_syn")
fig_dir <- "C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Figures_Aug/CO_RS"
...
ggsave("C:/Users/c3058452/OneDrive - Newcastle University/Work in Progress/Figures_Aug/CO_RS/control_response_rate_means.jpg",
       p, width = 6, height = 12)
